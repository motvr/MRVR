...
async def strcall(client, message):
    ...
    try:
        await assistant.join_group_call(message.chat.id, AudioPiped("./MazenMusic/assets/call.mp3"), stream_type=StreamType().pulse_stream)
        ...
        await message.reply("الكول مش مفتوح اصلاً")
    except TelegramServerError:
        await message.reply("ابعت الامر تاني في مشكله في سيرفر التليجرام ❌")
